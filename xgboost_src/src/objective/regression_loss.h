...
namespace xgboost
{
    namespace obj
    {
        ...
        struct LinearSquareLoss
        {
            ...
            static ObjInfo Info()
            {
                return {ObjInfo::kRegression, true, false};
            }
        };
        ...
        struct LogisticRegression
        {
            ...
            XGBOOST_DEVICE static bool CheckLabel(bst_float x)
            {
            ...
            static bst_float ProbToMargin(bst_float base_score)
            {
                CHECK(base_score > 0.0f && base_score < 1.0f) << "base_score must be in (0,1) for logistic loss, got: " << base_score;

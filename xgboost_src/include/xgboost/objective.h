...
namespace xgboost
{
    ...
    public:
         ...
         */
        virtual void UpdateTreeLeaf(HostDeviceVector<bst_node_t> const & /*position*/, MetaInfo const & /*info*/, HostDeviceVector<float> const & /*prediction*/, RegTree * /*p_tree*/) const
        {}
     ...
     */
    struct ObjFunctionReg : public dmlc::FunctionRegEntryBase<ObjFunctionReg, std::function<ObjFunction *()> >
    {
    };

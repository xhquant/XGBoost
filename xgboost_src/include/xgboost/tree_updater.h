...
namespace xgboost
{
    ...
    public:
         ...
         */
        virtual bool UpdatePredictionCache(const DMatrix * /*data*/, linalg::VectorView<float> /*out_preds*/)
        {
            return false;
        }
     ...
     */
    struct TreeUpdaterReg : public dmlc::FunctionRegEntryBase<TreeUpdaterReg, std::function<TreeUpdater *(GenericParameter const *tparam, ObjInfo task)> >
    {
    };
